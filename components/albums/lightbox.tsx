        ...
        <div className="relative flex min-h-0 flex-1 items-center justify-center px-4" onClick={(e) => e.stopPropagation()}>
          {index > 0 && (
            <Button
              ...
              className="absolute left-2 rounded-full bg-black/40 text-white hover:bg-black/60 sm:left-4"
            >
          ...
          {index < images.length - 1 && (
            <Button
              ...
              size="icon-lg"
              onClick={() => onIndexChange(index + 1)}
              className="absolute right-2 rounded-full bg-black/40 text-white hover:bg-black/60 sm:right-4"
            >
